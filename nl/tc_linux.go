...
const (
	TCA_CLS_FLAGS_SKIP_HW   = 1 << iota // don't offload filter to HW
	TCA_CLS_FLAGS_SKIP_SW   = 1 << iota // don't use filter in SW
	TCA_CLS_FLAGS_IN_HW     = 1 << iota // filter is offloaded to HW
	TCA_CLS_FLAGS_NOT_IN_HW = 1 << iota // filter isn't offloaded to HW
	TCA_CLS_FLAGS_VERBOSE   = 1 << iota // verbose logging
	TCA_CLS_FLAGS_LAST      = TCA_CLS_FLAGS_VERBOSE

	TCA_CLS_FLAGS_INPUT_MASK = TCA_CLS_FLAGS_SKIP_HW |
